...
//
//class NavifationDrawerActivity : Activity(), NavigationDrawerFragment.NavigationDrawerCallbacks {
//
//    /**
...
//        setContentView(R.layout.activity_navifation_drawer)
//
...
//        ): View? {
//            val rootView = inflater.inflate(R.layout.fragment_navifation_drawer, container, false)
//            return rootView
//        }
//
//        override fun onAttach(activity: Activity?) {
//            super.onAttach(activity)
//            (activity as NavifationDrawerActivity).onSectionAttached(
