...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        container.addOnPageChangeListener(TabLayout.TabLayoutOnPageChangeListener(tabs_dashboard))
        tabs_dashboard.addOnTabSelectedListener(TabLayout.ViewPagerOnTabSelectedListener(container))
    }
